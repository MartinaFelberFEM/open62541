...
START_TEST(Test_basic) {
    ...
    config->pubsubStateChangeCallback = PubSubStateChangeCallback_basic;
...
START_TEST(Test_different_timeouts) {
    ...
    */
    ...
    UA_ServerConfig *config = UA_Server_getConfig(server);
    /* set custom callback triggered for specific PubSub state changes */
    config->pubsubStateChangeCallback = PubSubStateChangeCallback_different_timeouts;
...
START_TEST(Test_wrong_timeout) {
    ...
    */
    ...
    UA_ServerConfig *config = UA_Server_getConfig(server);
    /* set custom callback triggered for specific PubSub state changes */
    config->pubsubStateChangeCallback = PubSubStateChangeCallback_wrong_timeout;
...
START_TEST(Test_many_components) {
    ...
    UA_ServerConfig *config = UA_Server_getConfig(server);
    /* set custom callback triggered for specific PubSub state changes */
    config->pubsubStateChangeCallback = PubSubStateChangeCallback_many_components;
...
START_TEST(Test_update_config) {
    ...
    UA_ServerConfig *config = UA_Server_getConfig(server);
    /* set custom callback triggered for specific PubSub state changes */
    config->pubsubStateChangeCallback = PubSubStateChangeCallback_update_config;
    MsgRcvTimeoutCallbackTriggerCnt = 0;
